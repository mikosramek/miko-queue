...
class GW2ItemLibrary {
  ...
  convertCopperToGold(amount) {
    ...
    return `${finalGold} <:gold_coin:863156987310899202> ${finalSilver > 9 ? finalSilver : `0${finalSilver}`} <:silver_coin:863156987382726667> ${copper > 9 ? copper : `0${copper}`} <:copper_coin:863156987667939338>`;
  }
}

module.exports = new GW2ItemLibrary();
